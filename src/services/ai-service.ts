...
2. Use modern CSS features:
   ...
   - Professional typography with Source Sans Pro and IBM Plex Sans fonts
   - WebMeccano colors: #34bfc2 (blue) and #F78D2B (orange)
3. Include interactive JavaScript:
   - Smooth scrolling, mobile menu toggles
...
- Always include: <!DOCTYPE html>, proper meta tags, viewport
- Include Google Fonts: <link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@400;600;700;900&family=IBM+Plex+Sans:wght@300;400;500;600&display=swap" rel="stylesheet">
- Use semantic HTML5 elements: header, nav, main, section, footer
- Ensure mobile-first responsive design

CSS STYLING REQUIREMENTS:
- ALL CSS must be inline in <style> tags in the HTML head
- Use CSS custom properties for colors: --primary: #34bfc2; --secondary: #F78D2B;
...
- Add beautiful gradients and shadows

JAVASCRIPT REQUIREMENTS (if needed):
- Include ALL JavaScript inline within <script> tags at bottom of body
- Add interactive features: smooth scrolling, form handling, mobile menu
...
1. Start with a brief description of what you built (NEVER include any code in description)
...
<head>
    ...
    <title>WebMeccano - Your Website Title</title>
    <link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@400;600;700;900&family=IBM+Plex+Sans:wght@300;400;500;600&display=swap" rel="stylesheet">
    <style>
        /* ALL CSS STYLING HERE */
        :root {
            --primary: #34bfc2;
            --secondary: #F78D2B;
        }
